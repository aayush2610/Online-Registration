...
body {
  ...
  <%
		...
		dispatcher.forward(request, response);
			...
			%>   			
    <%
    	String s=(String)request.getAttribute("aord");
    	if(s.equals("a_s")){
    	%>
    		...
    		<div class="container-fluid">
  				<div class="row content">
    				<div class="col-sm-3 sidenav">
        				...
        				<button name="option" type="submit" style="width:100%; margin:5px" class="btn btn-primary " value="approved_students">Approved Students</button>
        				...
        				<button name="option" type="submit" style="width:100%; margin:5px" class="btn" value="new">New Applications</button>
      					</form>
						</div>
			<div class="col-sm-9">
			<div align="right">
			...
			<center><h1>List Of Approved Students</h1></center><br>
    ...
    <%
     ...
     <td><%=i+"." %></td>
     	...
     	<td><%=dto.getName() %></td>
     	<td><a href="StudFac?id=<%=dto.getUsername() %>">View</a></td>
      </tr>
      <%} %>
    </tbody>
  </table>
    	...
    	<% }
    		...
    		<div class="container-fluid">
  				<div class="row content">
    				<div class="col-sm-3 sidenav">
        				...
        				<button name="option" type="submit" style="width:100%; margin:5px" class="btn btn-primary" value="disapproved_students">Disapproved Students</button>
        				<button name="option" type="submit" style="width:100%; margin:5px" class="btn" value="new">New Applications</button>
      					</form>
						</div>
			<div class="col-sm-9">
			...
			<center><h1>List Of Disapproved Students</h1></center>
