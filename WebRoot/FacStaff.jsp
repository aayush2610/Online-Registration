...
<%@page import="DAO.StaffDAO"%>
  <html>
	<head><title>Manage Faculty</title><link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
...
body {
  ...
  <div id="navigation">
	...
	<div class="login-page">
  		<div class="form" style="margin-top:auto;margin-left:503px;margin-bottom: 20px;">  
  			 <form class="login-form" action="FacStaffCTL" method="post" name="frm" method="post">
				   ...
				   <td> <button value="delete" name="operation" style="margin-left:2px;margin-right:2px">Delete</button></td>
				   ...
				   <center>To delete just enter the Username of the faculty and click Delete </center>
  </body>
</html>
