    ...
    <div class="col-sm-3 sidenav">
      ...
      <form class="login-form" action="FacultyCTL">
   	<input type="hidden" name="dto" value=<%=dto.getUsername() %>>
        ...
        <a href="Faculty.jsp"><button name="option" type="button" style="width:100%; margin:5px; color:black" class="btn btn-primary" value="">Home</button></a>
...
<!-- <div class="input-group">
    ...
    <div class="col-sm-9">
      ...
      <h5><span class="glyphicon gly.
      phicon-time"></span> Post by John Doe, Sep 24, 2015.</h5>
